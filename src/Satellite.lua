...
function Satellite:render()
    ...
    love.graphics.line(self.center_x, self.center_y, self.center_x + self.vel_x * 1000 / self.mass,
        self.center_y + self.vel_y * 1000 / self.mass)
    love.graphics.setColor(1, 0, 1)
    love.graphics.line(self.center_x, self.center_y, self.center_x + self.sumAccel_x * 100 * self.mass,
        self.center_y + self.sumAccel_y * 100 * self.mass)
end
